...
def check_position(line, query_db,target_db, args):
...
######
        ...
        diff_gene(query_genes, target_genes, dstart, dend, qstart, qend, query_db, args)
...
### The following part has to be uncommented if you want to run the script GFFalign.py as it is.
